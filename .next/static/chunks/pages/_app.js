...
/* harmony export */ });
/* harmony import */ var C_Users_pablo_Desktop_REGINA_PROGRAMACION_Assesments_axa_role_playing_game_app_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/next/node_modules/@babel/runtime/helpers/esm/defineProperty */ "./node_modules/next/node_modules/@babel/runtime/helpers/esm/defineProperty.js");
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { (0,C_Users_pablo_Desktop_REGINA_PROGRAMACION_Assesments_axa_role_playing_game_app_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var inhabitantsSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createSlice)({
  name: "inhabitants",
  initialState: initialState,
  reducers: {
    setInhabitants: function setInhabitants(state, action) {
      state.data = action.payload;
    },
    setSelectedID: function setSelectedID(state, action) {
...
var _inhabitantsSlice$act = inhabitantsSlice.actions,
    setInhabitants = _inhabitantsSlice$act.setInhabitants,
    setSelectedID = _inhabitantsSlice$act.setSelectedID,
    setSearch = _inhabitantsSlice$act.setSearch; // Selectors


var selectInhabitants = function selectInhabitants(state) {
  return state.inhabitants;
};
var selectSearch = function selectSearch(state) {
  return state.inhabitants.search;
};
var selectFilteredInhabitants = function selectFilteredInhabitants(state) {
  var inhabitants = state.inhabitants;
  var search = inhabitants.search,
      data = inhabitants.data;
...
var selectSelectedInhabitant = function selectSelectedInhabitant(state) {
  return state.inhabitants.data.find(function (inhab) {
    return inhab.id === state.inhabitants.selectedID;
  });
};
...
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
/* harmony import */ var _slices_inhabitants_slice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slices/inhabitants-slice */ "./src/app/slices/inhabitants-slice.ts");
/* module decorator */ module = __webpack_require__.hmd(module);
...
function makeStore() {
  return (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.configureStore)({
    reducer: {
      inhabitants: _slices_inhabitants_slice__WEBPACK_IMPORTED_MODULE_0__.default
    }
  });
}
var store = makeStore();
